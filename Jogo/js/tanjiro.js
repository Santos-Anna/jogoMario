...
const obstaculo = document.querySelector('.obstaculo_tanjiro'); // Corrigido!
const clouds = document.querySelector('.clouds');
const abelhas = document.querySelector('.abelhas');
const botaoIniciar = document.querySelector('.button');
const container = document.querySelector('.container_tangiro'); // Corrigido!
...
function iniciarJogo() {
    ...
    // Reset do Mario
    personagem.src ='./images/personagem2.gif';
    ...
    loop = setInterval(() => {
        ...
        if (obstaculoPosition <= 120 && obstaculoPosition > 0 && personagemPosition < 80) {
            ...
            personagem.src = './images/tanjiro_deitado.png';
            personagem.style.width = '200px';
